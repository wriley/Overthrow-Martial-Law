...
OT_NATO_VehicleGarrison_LevelOne = ["rhsusf_m1240a1_m2_usmc_wd","rhsusf_m1240a1_mk19_usmc_wd","rhsusf_m1043_w_m2","rhsusf_m1043_w_mk19","B_T_MRAP_01_hmg_F"];
OT_NATO_VehicleGarrison_LevelTwo = ["rhsusf_m1045_w","B_T_MRAP_01_gmg_F","rhsusf_m1240a1_m240_usarmy_wd","rhsusf_m1240a1_m2crows_usarmy_wd","rhsusf_m1240a1_mk19crows_usarmy_wd","rhsusf_CGRCAT1A2_M2_usmc_wd","rhsusf_CGRCAT1A2_Mk19_usmc_wd","rhsusf_M1220_M153_MK19_usarmy_wd","rhsusf_M1220_M153_M2_usarmy_wd"];
OT_NATO_VehicleGarrison_LevelThree = ["B_T_APC_Wheeled_01_cannon_F","B_T_AFV_Wheeled_01_cannon_F","B_T_AFV_Wheeled_01_up_cannon_F","rhsusf_stryker_m1126_m2_wd","rhsusf_stryker_m1126_mk19_wd"];
OT_NATO_StaticGarrison_LevelOne = ["B_HMG_01_high_F"];
OT_NATO_StaticGarrison_LevelTwo = ["B_GMG_01_high_F","RHS_M252_D"];
OT_NATO_StaticGarrison_LevelThree = ["B_T_Static_AT_F","B_T_Static_AA_F","RHS_M119_D"];

OT_NATO_CommTowers = ["Land_TTowerBig_1_F","Land_TTowerBig_2_F"];

OT_NATO_Unit_Sniper = ["B_T_Sniper_F","rhsusf_usmc_marpat_wd_sniper_m110","rhsusf_usmc_marpat_wd_sniper","rhsusf_usmc_marpat_wd_sniper_m107"];OT_NATO_Unit_Sniper = selectRandom OT_NATO_Unit_Sniper;
OT_NATO_Unit_Spotter = ["B_T_Spotter_F","rhsusf_usmc_marpat_wd_spotter","rhsusf_usmc_marpat_wd_jfo","rhsusf_usmc_marpat_wd_machinegunner","rhsusf_usmc_marpat_wd_grenadier"];OT_NATO_Unit_Spotter = selectRandom OT_NATO_Unit_Spotter;
OT_NATO_Unit_AA_spec = ["B_T_Soldier_AA_F","rhsusf_usmc_marpat_wd_stinger","rhsusf_usmc_marpat_wd_javelin","rhsusf_usmc_marpat_wd_smaw"];OT_NATO_Unit_AA_spec = selectRandom OT_NATO_Unit_AA_spec;
OT_NATO_Unit_AA_ass = ["B_T_Soldier_AAA_F","rhsusf_usmc_marpat_wd_javelin_asssistant"];OT_NATO_Unit_AA_ass = selectRandom OT_NATO_Unit_AA_ass;
OT_NATO_Unit_HVT = ["B_T_Officer_F","rhsusf_usmc_marpat_wd_officer","rhsusf_usmc_marpat_wd_fso"];OT_NATO_Unit_HVT = selectRandom OT_NATO_Unit_HVT;
OT_NATO_Unit_TeamLeader = ["B_T_Soldier_TL_F","rhsusf_usmc_marpat_wd_teamleader"];OT_NATO_Unit_TeamLeader = selectRandom OT_NATO_Unit_TeamLeader;
OT_NATO_Unit_SquadLeader = ["B_T_Soldier_SL_F","rhsusf_usmc_marpat_wd_squadleader"];OT_NATO_Unit_SquadLeader = selectRandom OT_NATO_Unit_SquadLeader;
...
OT_NATO_Vehicle_Transport = ["rhsusf_M1083A1P2_B_M2_WD_fmtv_usarmy","rhsusf_M1232_MC_MK19_usmc_wd","rhsusf_M1232_MC_M2_usmc_wd","B_T_Truck_01_covered_F","B_T_Truck_01_transport_F"];
...
OT_NATO_Vehicle_AirTransport_Large = ["B_Heli_Transport_03_F","B_T_VTOL_01_infantry_F"];
...
OT_portBuildings = ["Land_Warehouse_01_F","Land_i_Shed_Ind_old_F","Land_ContainerLine_01_F","Land_ContainerLine_02_F","Land_ContainerLine_03_F","Land_Cargo20_brick_red_F","Land_Cargo20_light_green_F","Land_Cargo20_orange_F","Land_Cargo20_grey_F"];
...
OT_warehouse = "Land_i_Shed_Ind_F";//"Land_Warehouse_03_F";
...
OT_refugeeCamp = "Land_Caravan_01_green_F";//"Land_Medevac_house_V1_F";
