...
private _description = format["A defector from the resistance is hiding in %1 under NATO protection and giving them sensitive information. He needs to be silenced. <br/><br/>Reward: $3500",_destinationName];
...
[
    ...
    _markerPos,
    {
        ...
        //reward to killer
        _civ setVariable ["OT_bounty",3500,true];//changed from 1500
    ...
    },
    {
        ...
        if (_wassuccess) then {
                [
			     {
				     [5500] call OT_fnc_resistanceFunds;//changed from 1500
