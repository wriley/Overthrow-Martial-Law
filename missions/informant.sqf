...
private _description = format["A defector from the resistance is hiding in %1 under NATO protection and giving them sensitive information. He needs to be silenced. <br/><br/>Reward: $5000",_destinationName];
...
[
    ...
    },
    {
        ...
        if (_wassuccess) then {
			...
			[5000] call OT_fnc_resistanceFunds; //changed from 1500
        };
        //Clean up
