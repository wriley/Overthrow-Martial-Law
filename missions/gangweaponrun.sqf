...
private _description = format["We need someone to deliver a %1 to a customer in %2. You have 6 hours.</t><br/><br/><t size='0.9' align='center'>Reward: +15 rep (%3), $%4",_gunname,_destinationName,_gangname,_reward];
...
[
    ...
    },
    {
        ...
        if(_wassuccess) then {
            ...
            [_player,_gangid,-25,format["Failed delivery of %1",_guncls call OT_fnc_weaponGetName]] call OT_fnc_gangRep;//changed from -5
        };
    },
    _params
];
