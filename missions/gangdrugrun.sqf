...
private _description = format["We need someone to deliver %1 x Ganja to a customer in %2. You have 6 hours.</t><br/><br/><t size='0.9' align='center'>Reward: +15 rep (%3), $%4",_numitems,_destinationName,_gangname,_reward];
