...
OT_startingMoney = [15000,15000,15000];
...
OT_loadingMessages = ["Dad?.. is that you?!","I can smell you","Pull these wires here","What?!","Kill some time here","How did that get here?","Rewriting code","Oh there it is!!","Oh shit I was looking for that","Ok this is awkward","*Stares back at you*","Smack AI awake","Launching boats","So how are you?","Loading Mods","Checking Keys","Hacking. . . .","Looking in your window","Don't answer the phone","Something is wrong here","Did you see that?!","Ok who fucking farted","Loading Trees","Rebuilding NATO FOB's","Forming a Resistance","You gonna eat all that?","Mining for Raw Sources","Hiring Employees","Are you winning son?","Activating Drones","Give AI a peptalk","Beating Devs","Planting IED's","Placing Gundealers","Allowing Factions in","Talking to Shopkeepers","Removing all female AI","Removing all child AI","Filling Water Table","Vcom Enabled","Randomizing Bandits","Gathering Gangs","Checking cba settings","LD Enabled","HC Functional","Give AI an attitude","Opening businesses","Spawn AI","Randomizing vehicles","Looking at Code"];
