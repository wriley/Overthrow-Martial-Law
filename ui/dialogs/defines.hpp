...
class RscEditOverthrow
{
	...
	font = "PuristaMedium";
	shadow = 2;
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * (0.25 + (0.3 / (pixelGrid / 14))))";
	canModify = 1;
	tooltipColorText[] =
	{
		1,
...
class RscOverthrowText
{
	...
	font = "PuristaMedium";
	SizeEx = "(((((2560 / safezoneH ) min 1.2) / 1.2) / 25) * (0.25 + (0.3 / (pixelGrid / 14))))";
	linespacing = 0.8;
	tooltipColorText[] =
	{
		1,
...
class RscOverthrowStructuredText
{
	...
	w = 0.1;
	text = "";
	size = "(((((2560 / safezoneH ) min 1.2) / 1.2) / 25) * (0.25 + (0.25 / (pixelGrid / 14))))";
	shadow = 0;
	lineSpacing = 0;
};
class RscOverthrowPicture
{
	deletable = 0;
	fade = 0;
	access = 0;
...
class RscOverthrowShortcutButton
{
	deletable = 0;
	fade = 0;
	type = 16;
	...
	sizeExSecondary = "(((((2560 / safezoneH ) min 1.2) / 1.2) / 25) * (0.25 + (0.3 / (pixelGrid / 14))))";
...
class RscOverthrowShortcutButtonMain
{
	idc = -1;
	style = 0;
	default = 0;
...
class RscOverthrowTextCheckBox
{
	idc = -1;
	type = 7;
	style = 0;
...
class RscOverthrowButtonMenuOK
{
	idc = 1;
	shortcuts[] =
	{
...
class RscOverthrowButtonMenuCancel
{
	idc = 2;
	shortcuts[] =
	{
